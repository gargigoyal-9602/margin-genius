          ...
          <>
               <TabContent className="details">
                    ...
                    <div className="sub-title">
                         ...
                         <div>
                              <button><Image src='/icons/move-up-arrow.svg' alt="" width="12px" height="12px" /></button>
                              <button><Image src='/icons/move-down-arrow.svg' alt="" width="12px" height="12px" /></button>
                         </div>
                    </div>
                    <AccordionBox>
                         <Accordion>
