                  ...
                  <div className="filter_box">
                    ...
                    <div className="filter_wrap">
                      <div className="filter_name">
                        <Image src="/icons/search.svg" height="13" width="13" alt="" />
                        <span className={layout.ml_10}>Graphic Design</span>
                      </div>
                      <div className="cutome_check">
                        <FormControlLabel control={<Checkbox />} label="Graphic Design" />
                      </div>
                      <div className="cutome_check">
        ...
        <span className={layout.mr_20}>
            ...
            <Fade in={openDelete}>
              <ModalBox>
                ...
                <div className={layout.mb_20}>
                  ...
                  <p>
                  The deals will be deleted immediately and this action cannot be undone.
                  </p>
                </div>
                <div className={layout.flex_between_center}>
                  ...
                  <IconButton onClose={handleDeleteClose} withText style={{width:'100%', marginLeft:'20px', height: '40px'}}>
                    <span className={layout.flex_center}>
                      <Image
                        alt=""
          ...
          <OutlineButton
            ...
            <ModalBox style={{width:'450px'}}>
                ...
                <div className={layout.mb_20}>
                  <h3>Choose the calculator for <br/>the new deal</h3>
                  <p>
                  ...
                  <Autocomplete
                    ...
                    renderInput={(params) => <TextField size="small" {...params} placeholder="Select or enter the name" />}
                    />
                ...
                <div className={layout.flex_between_center}>
                  ...
                  <MainButton onClose={handleClose} marginbottom="0px">
                    <span className={layout.flex_center}>
                      <span className={layout.ml_10}>Create New Deal</span>
                    </span>
                  </MainButton>
